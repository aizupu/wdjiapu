...
urlpatterns = [
    ...
    path('forget_passwd', mana_views.forget_passwd, name='forget_passwd'),
    path('forget_passwd_submit', mana_views.forget_passwd_submit, name='forget_passwd_submit'),
    ...
    path('genealogy/doc/upd/<id>', views.doc_upd, name='doc_upd'),
